// /* jsx representation of the 3d model */
...
//   {/* we are fixing the default mesh material to the one that better reacts to light so we have more control, for instance phong material is great for soft shade with subtle highlights   */ }
...
export function Room(props) {
  ...
  return (
    <group {...props} dispose={null}>
      <EffectComposer>
        {/* the monitor glowing is due to selective bloom */}
        <SelectiveBloom
